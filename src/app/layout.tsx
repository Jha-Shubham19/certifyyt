          ...
          <div className="relative flex min-h-screen flex-col">
            ...
            <main className="flex-1 flex items-stretch sm:items-center justify-center relative overflow-hidden min-h-[calc(100vh-4rem)] sm:min-h-screen">
              ...
              <div className="absolute inset-0">
                ...
                {/* Animated orbs */}
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-purple-500/30 to-pink-500/30 rounded-full blur-3xl animate-blob" />
                <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-blue-500/30 to-cyan-500/30 rounded-full blur-3xl animate-blob animation-delay-2000" />
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 rounded-full blur-2xl animate-float" />
              </div>
