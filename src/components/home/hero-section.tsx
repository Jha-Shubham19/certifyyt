...
export function HeroSection() {
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <Card className="glass-effect shadow-2xl relative overflow-hidden group transition-all duration-700 hover:shadow-2xl hover:shadow-purple-500/20 border border-white/10">
        {/* Animated Gradient Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 via-blue-600/5 to-pink-600/10 animate-gradient"></div>
        
        {/* Shimmer Effect */}
        <div className="absolute inset-0 animate-shimmer duration-10000"></div>

        {/* Card Header */}
        <CardHeader className="text-center relative z-10 pb-2 sm:pb-8">
          <div className="mb-1 sm:mb-6">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 mb-4 animate-pulse-glow">
        ...
        <CardContent className="relative z-10 pt-0">
          ...
          >
            ...
            <div className="pt-1 sm:pt-2">
              <Button
                type="submit"
                className="w-full h-12 sm:h-16 text-sm sm:text-xl font-bold rounded-2xl bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-600 hover:from-purple-700 hover:via-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-2xl hover:shadow-purple-500/25 transform hover:scale-[1.02] active:scale-[0.98]"
              >
